      ...
      body: Padding(
        ...
        child: ListView(
          children: const [
            ...
            SizedBox(height: 10),
            Text(
              'Project RADAR was created by a dedicated students at STI Sta Mesa who are passionate about improving public safety. Our goal is to continue enhancing the app with more features and support to ensure everyone’s safety, no matter where they are.',
              style: TextStyle(fontSize: 14),
            ),
          ],
        ),
